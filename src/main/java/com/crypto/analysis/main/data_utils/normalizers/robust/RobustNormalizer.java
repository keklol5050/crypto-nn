package com.crypto.analysis.main.data_utils.normalizers.robust;
...
public class RobustNormalizer implements Serializable {
    ...
    public RobustNormalizer(int[] mask, int countInputs, int countOutputs, int notVolatileLength, int volatileLength) {
        this.mask = mask;
